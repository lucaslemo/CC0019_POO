...
public class ControleSistemaConsultaCustos implements Initializable{
    ...
    private void initialize() {
		...
		total.setText("Seu custo mensal total é de R$" + usuario.consultarCustosPrevistos() + "!");
    }
	...
	public void func01() {
		if(!id.getText().equals("")) {
			if(Ultilitarios.testaNumero(id.getText()) == 1) {
				...
				if(aux != null) {
					fazenda.setText("Essa fazenda tem um custo mensal de R$" + usuario.consultarCustosPrevistosF(Integer.valueOf(id.getText())) + "!");
				}
				else {
